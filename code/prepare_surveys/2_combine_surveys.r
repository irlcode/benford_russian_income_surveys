...
# WGT — household post-stratification weight
...
rlms_household <- rlms_household[, c("id_w", "id_h", "site", "wgt", "representative", "g5", "f14", "f2", "a4.1", "a4.2", "a5.1", "a5.2"), with = F]
...
rlms_household_representative <- rlms_household[representative == 1, c("survey", "level", "year", "id", "area_id", "wgt", "confidence", "income", "amount_living_normally", "interview_date", "interview_duration"), with = F]
rlms_household_representative[, survey := "RLMSrepr" ]

rlms_household <- rlms_household[, c("survey", "level", "year", "id", "area_id", "wgt", "confidence", "income", "amount_living_normally", "interview_date", "interview_duration"), with = F]
rlms_household_representative <- rlms_household_representative[, c("survey", "level", "year", "id", "area_id", "wgt", "confidence", "income", "amount_living_normally", "interview_date", "interview_duration"), with = F]
...
rlms_individual <- rlms_individual[, c("id_w", "idind", "site", "wgt", "representative", "s5", "j60", "j69.8a", "j69.8b", "j69.8c", "h7.1", "h7.2", "h8a", "h8b"), with = F]
...
# Separate subset with only representative observations
rlms_individual_representative <- rlms_individual[representative == 1, c("survey", "level", "year", "id", "area_id", "wgt", "confidence", "income", "amount_living_normally", "amount_living_well", "amount_living_poorly", "interview_date", "interview_duration"), with = F]
rlms_individual_representative[, survey := "RLMSrepr" ]

rlms_individual <- rlms_individual[, c("survey", "level", "year", "id", "area_id", "wgt", "confidence", "income", "amount_living_normally", "amount_living_well", "amount_living_poorly", "interview_date", "interview_duration"), with = F]
...
kouzh_2011_household <- kouzh_2011_household[, c("ID_HH", "Weight", "CitySize", "H_04_03_01_00", "H_04_03_02_00", "H_04_03_03_00", "Income"), with = F]
...
setnames(kouzh_2011_household, c("ID_HH", "Weight", "CitySize", "H_04_03_01_00", "H_04_03_02_00", "H_04_03_03_00", "Income"), c("id", "wgt", "area_id", "amount_living_well", "amount_living_normally", "amount_living_poorly", "income"))
kouzh_2011_household <- kouzh_2011_household[, c("survey", "level", "year", "id", "area_id", "wgt", "income", "amount_living_well", "amount_living_normally", "amount_living_poorly"), with = F]
...
kouzh_2014_household <- kouzh_2014_household[, c("H00_06", "KVZV", "H04_03_01", "H04_03_02", "H04_03_03", "DOX_mean"), with = F]
...
setnames(kouzh_2014_household, c("H00_06", "KVZV", "DOX_mean", "H04_03_01", "H04_03_02", "H04_03_03"), c("id", "wgt", "income", "amount_living_well", "amount_living_normally", "amount_living_poorly"))
kouzh_2014_household <- kouzh_2014_household[, c("survey", "level", "year", "id", "wgt", "income", "amount_living_well", "amount_living_normally", "amount_living_poorly"), with = F]
...
kouzh_2016_household <- kouzh_2016_household[, c("H00_06", "KVZV2", "H04_051", "DOX_mean"), with = F]
...
setnames(kouzh_2016_household, c("H00_06", "KVZV2", "DOX_mean", "H04_051"), c("id", "wgt", "income", "amount_living_poorly"))
kouzh_2016_household <- kouzh_2016_household[, c("survey", "level", "year", "id",  "wgt", "income", "amount_living_poorly"), with = F]
...
kouzh_2018_household <- kouzh_2018_household[, c("H00_06", "KVZV", "DOX_mean"), with = F]
...
setnames(kouzh_2018_household, c("H00_06", "KVZV", "DOX_mean"), c("id", "wgt", "income"))
kouzh_2018_household <- kouzh_2018_household[, c("survey", "level", "year", "id", "wgt", "income"), with = F]
...
kouzh_2020_household <- kouzh_2020_household[, c("H00_06", "KVZV", "H04_051", "DOX_mean"), with = F]
...
setnames(kouzh_2020_household, c("H00_06", "KVZV", "DOX_mean", "H04_051"), c("id", "wgt", "income", "amount_living_poorly"))
kouzh_2020_household <- kouzh_2020_household[, c("survey", "level", "year", "id", "wgt", "income", "amount_living_poorly"), with = F]
...
kouzh_2022_household <- kouzh_2022_household[, c("H00_06", "KVZV", "H04_051", "DOX_mean"), with = F]
...
setnames(kouzh_2022_household, c("H00_06", "KVZV", "DOX_mean", "H04_051"), c("id", "wgt", "income", "amount_living_poorly"))
kouzh_2022_household <- kouzh_2022_household[, c("survey", "level", "year", "id", "wgt", "income", "amount_living_poorly"), with = F]
...
vndn_2012_household <- vndn_2012_household[, c("H_R0V6", "weight", "H_R8V4_1_1", "H_R8V4_2_1", "H_R8V4_3_1", "DEN"), with = F]
...
setnames(vndn_2012_household, c("H_R0V6", "weight", "DEN", "H_R8V4_1_1", "H_R8V4_2_1", "H_R8V4_3_1"), c("id", "wgt", "income", "amount_living_well", "amount_living_normally", "amount_living_poorly"))
vndn_2012_household <- vndn_2012_household[, c("survey", "level", "year", "id", "wgt", "income", "amount_living_well", "amount_living_normally", "amount_living_poorly"), with = F]
...
vndn_2012_individual <- vndn_2012_individual[, c("I_R0V6", "weight", "I_R0V7", "R_I_FOT_DEN"), with = F]
...
setnames(vndn_2012_individual, c("weight", "R_I_FOT_DEN"), c("wgt", "income"))
vndn_2012_individual <- vndn_2012_individual[, c("survey", "level", "year", "id", "wgt", "income"), with = F]
...
vndn_2014_household <- vndn_2014_household[, c("H00_06", "KVZV", "H07_08_01", "H07_08_02", "H07_08_03", "R_H_DOXOD_DEN"), with = F]
...
setnames(vndn_2014_household, c("H00_06", "KVZV", "R_H_DOXOD_DEN", "H07_08_01", "H07_08_02", "H07_08_03"), c("id", "wgt", "income", "amount_living_well", "amount_living_normally", "amount_living_poorly"))
vndn_2014_household <- vndn_2014_household[, c("survey", "level", "year", "id", "wgt", "income", "amount_living_well", "amount_living_normally", "amount_living_poorly"), with = F]
...
vndn_2014_individual <- vndn_2014_individual[, c("H00_06", "KVZV", "H01_00", "R_DEN"), with = F]
...
setnames(vndn_2014_individual, c("KVZV", "R_DEN"), c("wgt", "income"))
vndn_2014_individual <- vndn_2014_individual[, c("survey", "level", "year", "id", "wgt", "income"), with = F]
...
vndn_2015_household <- vndn_2015_household[, c("H00_06", "KVZV", "H07_08_01", "H07_08_02", "H07_08_03", "R_H_DOXOD_DEN"), with = F]
...
setnames(vndn_2015_household, c("H00_06", "KVZV", "R_H_DOXOD_DEN", "H07_08_01", "H07_08_02", "H07_08_03"), c("id", "wgt", "income", "amount_living_well", "amount_living_normally", "amount_living_poorly"))
vndn_2015_household <- vndn_2015_household[, c("survey", "level", "year", "id", "wgt", "income", "amount_living_well", "amount_living_normally", "amount_living_poorly"), with = F]
...
vndn_2015_individual <- vndn_2015_individual[, c("H00_06", "KVZV", "H01_00", "R_DEN"), with = F]
...
setnames(vndn_2015_individual, c("KVZV", "R_DEN"), c("wgt", "income"))
vndn_2015_individual <- vndn_2015_individual[, c("survey", "level", "year", "id", "wgt", "income"), with = F]
...
vndn_2016_household <- vndn_2016_household[, c("H00_06", "KVZV", "H07_08_01", "H07_08_02", "H07_08_03", "R_H_DOXOD_DEN"), with = F]
...
setnames(vndn_2016_household, c("H00_06", "KVZV", "R_H_DOXOD_DEN", "H07_08_01", "H07_08_02", "H07_08_03"), c("id", "wgt", "income", "amount_living_well", "amount_living_normally", "amount_living_poorly"))
vndn_2016_household <- vndn_2016_household[, c("survey", "level", "year", "id", "wgt", "income", "amount_living_well", "amount_living_normally", "amount_living_poorly"), with = F]
...
vndn_2016_individual <- vndn_2016_individual[, c("H00_06", "KVZV", "H01_00", "R_DEN"), with = F]
...
setnames(vndn_2016_individual, c("KVZV", "R_DEN"), c("wgt", "income"))
vndn_2016_individual <- vndn_2016_individual[, c("survey", "level", "year", "id", "wgt", "income"), with = F]
...
vndn_2017_household <- vndn_2017_household[, c("H00_06", "KVZV", "H07_04", "R_H_DOXOD_DEN"), with = F]
...
setnames(vndn_2017_household, c("H00_06", "KVZV", "R_H_DOXOD_DEN", "H07_04"), c("id", "wgt", "income", "amount_living_poorly"))
vndn_2017_household <- vndn_2017_household[, c("survey", "level", "year", "id", "wgt", "income", "amount_living_poorly"), with = F]
...
vndn_2017_individual <- vndn_2017_individual[, c("H00_06", "KVZV", "H01_00", "R_DEN"), with = F]
...
setnames(vndn_2017_individual, c("KVZV", "R_DEN"), c("wgt", "income"))
vndn_2017_individual <- vndn_2017_individual[, c("survey", "level", "year", "id", "wgt", "income"), with = F]
...
vndn_2018_household <- vndn_2018_household[, c("H00_06", "KVZV", "R_H_DOXOD_DEN"), with = F]
...
setnames(vndn_2018_household, c("H00_06", "KVZV", "R_H_DOXOD_DEN"), c("id", "wgt", "income"))
vndn_2018_household <- vndn_2018_household[, c("survey", "level", "year", "id", "wgt", "income"), with = F]
...
vndn_2018_individual <- vndn_2018_individual[, c("H00_06", "KVZV", "H01_00", "R_DEN"), with = F]
...
setnames(vndn_2018_individual, c("KVZV", "R_DEN"), c("wgt", "income"))
vndn_2018_individual <- vndn_2018_individual[, c("survey", "level", "year", "id", "wgt", "income"), with = F]
...
vndn_2019_household <- vndn_2019_household[, c("H00_06", "KVZV", "R_H_DOXOD_DEN"), with = F]
...
setnames(vndn_2019_household, c("H00_06", "KVZV", "R_H_DOXOD_DEN"), c("id", "wgt", "income"))
vndn_2019_household <- vndn_2019_household[, c("survey", "level", "year", "id", "wgt", "income"), with = F]
...
vndn_2019_individual <- vndn_2019_individual[, c("H00_06", "KVZV", "H01_00", "R_DEN"), with = F]
...
setnames(vndn_2019_individual, c("KVZV", "R_DEN"), c("wgt", "income"))
vndn_2019_individual <- vndn_2019_individual[, c("survey", "level", "year", "id", "wgt", "income"), with = F]
...
vndn_2020_household <- vndn_2020_household[, c("H00_06", "KVZV", "R_H_DOXOD_DEN"), with = F]
...
setnames(vndn_2020_household, c("H00_06", "KVZV", "R_H_DOXOD_DEN"), c("id", "wgt", "income"))
vndn_2020_household <- vndn_2020_household[, c("survey", "level", "year", "id", "wgt", "income"), with = F]
...
vndn_2020_individual <- vndn_2020_individual[, c("H00_06", "KVZV", "H01_00", "R_DEN"), with = F]
...
setnames(vndn_2020_individual, c("KVZV", "R_DEN"), c("wgt", "income"))
vndn_2020_individual <- vndn_2020_individual[, c("survey", "level", "year", "id", "wgt", "income"), with = F]
...
vndn_2021_household <- vndn_2021_household[, c("H00_06", "KVZV", "R_H_DOXOD_DEN"), with = F]
...
setnames(vndn_2021_household, c("H00_06", "KVZV", "R_H_DOXOD_DEN"), c("id", "wgt", "income"))
vndn_2021_household <- vndn_2021_household[, c("survey", "level", "year", "id", "wgt", "income"), with = F]
...
vndn_2021_individual <- vndn_2021_individual[, c("H00_06", "KVZV", "H01_00", "R_DEN"), with = F]
...
setnames(vndn_2021_individual, c("KVZV", "R_DEN"), c("wgt", "income"))
vndn_2021_individual <- vndn_2021_individual[, c("survey", "level", "year", "id", "wgt", "income"), with = F]
...
vndn_2022_household <- vndn_2022_household[, c("H00_06", "KVZV", "R_H_DOXOD_DEN"), with = F]
...
setnames(vndn_2022_household, c("H00_06", "KVZV", "R_H_DOXOD_DEN"), c("id", "wgt", "income"))
vndn_2022_household <- vndn_2022_household[, c("survey", "level", "year", "id", "wgt", "income"), with = F]
...
vndn_2022_individual <- vndn_2022_individual[, c("H00_06", "H01_00", "KVZV", "R_DEN"), with = F]
...
setnames(vndn_2022_individual, c("KVZV", "R_DEN"), c("wgt", "income"))
vndn_2022_individual <- vndn_2022_individual[, c("survey", "level", "year", "id", "wgt", "income"), with = F]
...
cbr_survey_waves_1_5_household <- cbr_survey_waves_1_5_household[, c("id_w", "id_h", "hhwgt", "h31_r", "h48_r", "h_x5")]
...
setnames(cbr_survey_waves_1_5_household, c("id_h", "hhwgt"), c("id", "wgt"))
cbr_survey_waves_1_5_household <- cbr_survey_waves_1_5_household[, c("survey", "level", "year", "id", "wgt", "confidence", "income"), with = F]
...
cbr_survey_waves_1_5_individual <- cbr_survey_waves_1_5_individual[, c("id_w", "inwgt", "i_x5", "id_i", "k66_r", "k66a_r")]
...
setnames(cbr_survey_waves_1_5_individual, c("id_i", "inwgt"), c("id", "wgt"))
cbr_survey_waves_1_5_individual <- cbr_survey_waves_1_5_individual[, c("survey", "level", "year", "id", "wgt", "confidence", "income"), with = F]
